            ...
            photos.map((photo: PhotoType["content"]) =>
              <>
                {!isMobile && (
                  <div
                    key={photo.docId}
                    className="relative group bg-black-faded flex items-center"
                  >
                    <img src={photo.imageSrc} alt={photo.caption} loading="lazy" />
                ...
                {isMobile && <Post key={photo.docId} content={photo} />}
              </>
            )) : null}
      </div>
